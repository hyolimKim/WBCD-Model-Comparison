...
본 연구에서는 유방암 진단의 **정량적 의사결정 지원 시스템 구축** 을 위해, 세포 병리학적 특징을 활용한 **악성/양성 여부를 예측하는 머신러닝 모델(SVM, MLP, Random Forest)** 을 비교합니다.
...
1. **모델 유효성 비교**: **SVM, MLP, Random Forest ** 모델의 유방암 진단 성능을 ROC-AUC와 K-fold 기준으로 비교 분석합니다.
